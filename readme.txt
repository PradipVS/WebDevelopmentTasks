Project Title : Responsive Company Member Team Page


Description :
	Our first objective is to create a responsive web page for the Company Member Team Page showcasing the members of our company’s team. Our key responsibilities includes the design and develop a responsive web page in a visually appealing layout for the team page , ensure that the page is responsive and displays well on various devices such as mobiles, desktops and tablets. We also gather necessary informations about the team members including the names , positions , photos and implement smooth navigation and user-friendly experience in order to explore the team member’s profiles so easier.  This task includes the proficiency knowledge of HTML , CSS and the knowledge of responsive design principles and techniques. 
